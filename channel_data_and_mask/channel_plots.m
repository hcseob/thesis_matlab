...
figure; hold all;
plot(IL.f/1e9, -db(IL.nel1), '-', 'color', 'k', 'linewidth', 3);
plot(IL.f/1e9, -db(IL.nel0), '--', 'color', stanford_red, 'linewidth', 3);
plot(IL.f/1e9, -db(IL.nel2), ':', 'color', new_blue, 'linewidth', 3);
xlim([0, 15]);
ylim([0, 40]);
set(gca, 'fontsize', 18);
...
figure; hold all;
plot(p_norm.t/1e-12, p_norm.nel1, '-', 'color', 'k', 'linewidth', 3);
plot(p_norm.t/1e-12, p_norm.nel0, '--', 'color', stanford_red, 'linewidth', 3);
plot(p_norm.t/1e-12, p_norm.nel2, ':', 'color', new_blue, 'linewidth', 3);
